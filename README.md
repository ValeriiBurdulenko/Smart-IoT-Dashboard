...
* ✅ **Complex Event Processing (CEP):** **Apache Flink** is used for on-the-fly anomaly detection (e.g., "Temperature dropping while Heater is ON") instead of heavy ML models.
...
* ✅ **Async Command Pattern:** Device management with delivery guarantees. The backend implements **Optimistic UI** with execution acknowledgement (ACK) via WebSockets.
* ✅ **Hybrid Persistence:**
